...
Переход по ссылкам для авторизации меня не устраивает, поэтому пришлось что-то придумывать. [Некоторым способом](https://sohabr.net/habr/post/233439/) мне удалось получить client_id и client_secret
